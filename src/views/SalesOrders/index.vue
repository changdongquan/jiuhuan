      ...
      <el-table-column type="expand">
        <template #default="{ row }">
          ...
          >
            ...
            <el-table-column prop="costSource" label="费用出处" min-width="140" show-overflow-tooltip />
          </el-table>
        </template>
      </el-table-column>
      ...
      >
        <div class="dialog-form-columns">
          <div class="dialog-form-column dialog-form-column--left">
            <el-form-item label="订单编号" prop="orderNo">
              <el-input v-model="dialogForm.orderNo" placeholder="请输入订单编号" class="dialog-input" />
            </el-form-item>
          ...
          <div class="dialog-form-column dialog-form-column--right">
            <el-form-item label="客户名称" prop="customerName">
              <el-input v-model="dialogForm.customerName" placeholder="请输入客户名称" class="dialog-input" />
            </el-form-item>
          <el-form-item label="签订日期">
            ...
            <el-form-item label="合同编号">
              <el-input v-model="dialogForm.contractNo" placeholder="请输入合同编号" class="dialog-input" />
            </el-form-item>
          </div>
        </div>
        ...
        <div class="dialog-product-section">
          ...
          <div class="dialog-product-summary">
            ...
            <div>
              <span class="dialog-product-summary__item">产品项数：{{ dialogForm.details.length }}</span>
              <span class="dialog-product-summary__item">总数量：{{ dialogTotals.totalQuantity }}</span>
...
const assignDialogForm = (payload: OrderPayload) => {
  ...
  dialogForm.details.splice(0, dialogForm.details.length, ...payload.details.map((detail) => ({ ...detail })))
