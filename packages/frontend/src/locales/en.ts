export default {
  ...
  router: {
    ...
    projectManagementList: 'Project Management List',
    productionTasks: 'Production Tasks',
    billingDocuments: 'Billing Documents',
    receivableDocuments: 'Receivable Documents',
  ...
  comprehensive: {
    summary: 'Filters',
    keyword: 'Keyword',
    keywordPlaceholder: 'Search by document number or description',
    ...
    analysisPlaceholder: 'No data yet. Adjust the filters.',
  ...
  procurement: {
    ...
    orderCode: 'Outsourcing No.',
    orderPlaceholder: 'Enter outsourcing number',
    status: 'Progress',
    dueRange: 'Planned Completion',
    totalOrders: 'Orders',
    pendingAmount: 'Pending Amount',
    inProgressCount: 'In Progress',
    delayedCount: 'Delayed',
    serial: 'No.',
    partName: 'Part / Process',
    quantity: 'Quantity',
    amount: 'Amount',
    plannedDate: 'Plan Date',
    actualDate: 'Actual Date',
    remark: 'Remark',
    statusPending: 'To Schedule',
  ...
  processOutsourcing: {
    supplierName: 'Outsourcing Vendor',
    supplierPlaceholder: 'Enter vendor name',
    orderCode: 'Outsourcing No.',
    orderCodePlaceholder: 'Enter outsourcing number',
    ...
    addOrder: 'Add Order',
    totalOrders: 'Outsourcing Orders',
    inProgressCount: 'In Progress',
    completedCount: 'Completed',
    serial: 'No.',
  ...
  inventory: {
    serial: 'No.',
    materialCode: 'Material Code',
    materialPlaceholder: 'Enter material code',
    materialName: 'Material Name',
    materialNamePlaceholder: 'Enter material name',
    category: 'Category',
    categoryRaw: 'Raw Material',
    categoryParts: 'Semi-finished / Parts',
    categoryFinished: 'Finished Goods',
    warehouse: 'Warehouse',
    ...
    remark: 'Remark',
    notFound: 'Material not found in inventory',
    notEnough: 'Inventory quantity is insufficient',
    transferFromNotFound: 'Source warehouse does not have this material',
    transferSameWarehouse: 'Source and destination warehouses cannot be the same'
  },
  inventoryInbound: {
    title: 'Inbound Tasks',
    description: 'Track supplier deliveries, quality inspection, and receiving progress.',
    documentNo: 'Inbound No.',
    documentPlaceholder: 'Enter inbound document number',
    supplier: 'Supplier',
    supplierPlaceholder: 'Enter supplier',
    materialCode: 'Material Code',
    materialCodePlaceholder: 'Enter or select material code',
    materialName: 'Material Name',
    materialNamePlaceholder: 'Enter or select material name',
    status: 'Status',
    arrivalDate: 'Planned Arrival',
    arrivalPlaceholder: 'Select planned arrival date',
    quantityPlaceholder: 'Enter inbound quantity',
    submit: 'Confirm Inbound',
    success: 'Inbound record created',
    statusWaiting: 'Pending QC',
    statusReceived: 'Received',
    rules: {
      document: 'Inbound number is required',
      supplier: 'Supplier is required',
      material: 'Select or enter material code',
      ...
      warehouse: 'Select inbound warehouse'
    }
  },
  inventoryOutbound: {
    title: 'Outbound Execution',
    description: 'Monitor production issue and shipment progress to ensure on-time delivery.',
    documentNo: 'Outbound No.',
    documentPlaceholder: 'Enter outbound document number',
    target: 'Destination',
    targetPlaceholder: 'Enter destination or production line',
    materialCode: 'Material Code',
    materialName: 'Material Name',
    quantityPlaceholder: 'Enter outbound quantity',
    warehousePlaceholder: 'Select outbound warehouse',
    status: 'Status',
    deliveryDate: 'Delivery Date',
    deliveryPlaceholder: 'Select delivery date',
    submit: 'Confirm Outbound',
    success: 'Outbound record created',
    statusAllocated: 'Allocated',
    statusShipped: 'Shipped',
    rules: {
      document: 'Outbound number is required',
      target: 'Destination is required',
      material: 'Select material to ship',
      quantity: 'Enter a valid quantity',
      deliveryDate: 'Select delivery date',
      warehouse: 'Select outbound warehouse'
    }
  },
  inventoryTransfer: {
    title: 'Warehouse Transfer',
    description: 'Record inter-warehouse transfers and keep an eye on in-transit inventory.',
    documentNo: 'Transfer No.',
    documentPlaceholder: 'Enter transfer number',
    materialCode: 'Material Code',
    materialName: 'Material Name',
    fromWarehouse: 'From Warehouse',
    fromWarehousePlaceholder: 'Select source warehouse',
    toWarehouse: 'To Warehouse',
    toWarehousePlaceholder: 'Select or enter destination warehouse',
    quantityPlaceholder: 'Enter transfer quantity',
    transferDate: 'Transfer Date',
    transferPlaceholder: 'Select transfer date',
    ...
    statusCompleted: 'Completed',
    rules: {
      document: 'Transfer number is required',
      material: 'Select material to transfer',
      fromWarehouse: 'Select source warehouse',
      toWarehouse: 'Select destination warehouse',
      quantity: 'Enter a valid transfer quantity',
      transferDate: 'Select transfer date'
    }
  },
  inventoryStocktake: {
    title: 'Stocktake Plans',
    description: 'Follow each counting plan, reconcile differences, and update books promptly.',
    planName: 'Plan',
    planPlaceholder: 'Enter stocktake plan',
    range: 'Scope',
    rangePlaceholder: 'Enter stocktake scope',
    executor: 'Owner',
    executorPlaceholder: 'Enter owner',
    materialCode: 'Material Code',
    materialName: 'Material Name',
    countedQuantity: 'Counted Quantity',
    countedPlaceholder: 'Enter counted quantity',
    scheduledDate: 'Scheduled Date',
    scheduledPlaceholder: 'Select scheduled date',
    status: 'Status',
    difference: 'Variance',
    submit: 'Record Stocktake',
    success: 'Stocktake recorded',
    statusOnGoing: 'On Going',
    statusCompleted: 'Completed',
    rules: {
      planName: 'Plan name is required',
      range: 'Scope is required',
      executor: 'Owner is required',
      material: 'Select material to count',
      warehouse: 'Select counted warehouse',
      countedQuantity: 'Enter a valid counted quantity',
      scheduledDate: 'Select stocktake date'
    }
  }
}
