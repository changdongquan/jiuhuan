...
2. 打开文件：`backend/scripts/create-permission-tables.sql`
3. 执行脚本
4. 确认三张表创建成功：
   - `permissions`
   - `user_permissions`
...
# 执行 SQL 脚本
sqlcmd -S localhost -d jiuhuanDB -U sa -P Chang902 -i /opt/jh-craftsys/source/backend/scripts/create-permission-tables.sql
```
